...
#
# proj.tcl: Tcl script for re-creating project 'spmv_mult_design'
#
# Generated by Vivado on Mon Sep 17 16:23:17 CEST 2018
...
#
#    "/home/asiatici/epfl/memory-coalescer/vivado/spmv/07_4spmvrtl_psddr_minimalfpgamshr/spmv_mult_design.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
...
set orig_proj_dir "[file normalize "$origin_dir/07_4spmvrtl_psddr_minimalfpgamshr"]"
...
# End of write_mig_file_design_1_mig_7series_0_0()
  ...
  delete_bd_objs [get_bd_intf_nets FullyPipelinedSpMVRTL_0_output_stream]
  connect_bd_intf_net [get_bd_intf_pins FullyPipelinedSpMVRTL_0/output_stream] [get_bd_intf_pins axis_register_slice_0/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_net [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins mig_7series_0/ui_clk]
  connect_bd_net [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]

  create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_1
  delete_bd_objs [get_bd_intf_nets FullyPipelinedSpMVRTL_1_output_stream]
  connect_bd_intf_net [get_bd_intf_pins FullyPipelinedSpMVRTL_1/output_stream] [get_bd_intf_pins axis_register_slice_1/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins axi_dma_3/S_AXIS_S2MM]
  connect_bd_net [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins mig_7series_0/ui_clk]
  connect_bd_net [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]

  create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_2
  delete_bd_objs [get_bd_intf_nets FullyPipelinedSpMVRTL_2_output_stream]
  connect_bd_intf_net [get_bd_intf_pins FullyPipelinedSpMVRTL_2/output_stream] [get_bd_intf_pins axis_register_slice_2/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins axi_dma_6/S_AXIS_S2MM]
  connect_bd_net [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins mig_7series_0/ui_clk]
  connect_bd_net [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]

  create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_3
  delete_bd_objs [get_bd_intf_nets FullyPipelinedSpMVRTL_3_output_stream]
  connect_bd_intf_net [get_bd_intf_pins FullyPipelinedSpMVRTL_3/output_stream] [get_bd_intf_pins axis_register_slice_3/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins axis_register_slice_3/M_AXIS] [get_bd_intf_pins axi_dma_9/S_AXIS_S2MM]
  connect_bd_net [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins mig_7series_0/ui_clk]
  connect_bd_net [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]
